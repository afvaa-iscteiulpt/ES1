...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 * fileRules.createNewRule("LALALA", 4); fileRules.deleteRule("LALALA");
		 * fileRules.replaceFileContent();
		 * 
		 * FileEmail fileHam = new FileEmail(TypeEmail.HAM);
		 * System.out.println("FP = " +
		 * fileHam.calculateFPandFN(fileRules.getHmapRules())); FileEmail
		 * fileSpam = new FileEmail(TypeEmail.SPAM); System.out.println("FN = "
		 * + fileSpam.calculateFPandFN(fileRules.getHmapRules()));
		 * 
		 * runMultipleTests(10000);
		 * 
		 * String[] rulesToModified = {"SUBJ_AS_SEEN", "DNS_FROM_RFC_BOGUSMX",
		 * "DRUGS_DIET"}; fileRules.applyToRules(rulesToModified, -10);
		 * fileRules.replaceFileContent();
		 */
